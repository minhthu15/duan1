...
function update_sanpham($id, $iddm ,$tensp, $giasp, $hinh, $mota){
    if($hinh != ""){
        $sql = "update truyen set id_the_loai='".$iddm."', name='".$tensp."', price='".$giasp."', mota='".$mota."', img='".$hinh."' where id=".$id;
    }else{
        $sql = "update truyen set id_the_loai='".$iddm."', name='".$tensp."', price='".$giasp."', mota='".$mota."' where id=".$id;
    }
    pdo_execute($sql);
}
