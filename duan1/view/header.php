                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-4 col-12">
                        <div class="logo-area text-center logo-xs-mrg">
                            <a href="index.html"><img src="view/img/logo/logo.png" alt="logo" /></a>
                        </div>
                    </div>
                                ...
                                <li><a href="#"><i class="fa fa-shopping-cart"></i>Giỏ hàng của tôi</a>
                                    ...
                                    <div class="mini-cart-sub">
                                        ...
                                        <div class="cart-bottom">
                                            <a class="view-cart" href="index.php?act=addtocart">Xem giỏ hàng</a>
                        ...
                        <div class="menu-area">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="product-details.html">Thể loại<i class="fa fa-angle-down"></i></a>
                                        <div class="mega-menu">
                                            <?php
